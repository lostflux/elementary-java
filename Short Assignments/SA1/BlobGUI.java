...
public class BlobGUI extends DrawingGUI {
	...
	public BlobGUI() {
		...
		// Create blob.
		blob = new Rush(width/2, height/2);  // What happens if this isn't here? Try it so you see the symptom.
	...
	public void handleMousePress(int x, int y) {
		...
		//Modified part to allow creation of Rush() instances:
		else if (blobType == 'r') {
			blob = new Rush(x,y);
		} //End of plugged-in modified code
		else {
